...
// Database engine selection: 'mongo' (default) or 'postgres'
...
// Postgres connection settings (used only when DB_ENGINE=postgres)
...
module.exports = { LogLevel, PORT, PRODUCTION, MONGODB_URI, API_KEY, DEVICE_COLLECTION_PREFIX, LOG_LEVEL, URL_PREFIX, DB_ENGINE, PGHOST, PGPORT, PGUSER, PGPASSWORD, PGDATABASE, COORDS_NORMALIZED };
